...
TVector3 shower::LArPandoraShowerAlg::ShowerCentre(std::vector<art::Ptr<recob::SpacePoint> > const&
  ...
  float totalCharge=0;
  TVector3 centre =  shower::LArPandoraShowerAlg::ShowerCentre(showerspcs,fmh,totalCharge);
  return centre;

}

//Returns the vector to the shower centre and the total charge of the shower.
TVector3 shower::LArPandoraShowerAlg::ShowerCentre(std::vector<art::Ptr<recob::SpacePoint> > const& showersps,
...
TVector2 shower::LArPandoraShowerAlg::HitCoordinates(art::Ptr<recob::Hit> const& hit) const {
...
void shower::LArPandoraShowerAlg::DebugEVD(art::Ptr<recob::PFParticle> const& pfparticle,
  ...
  if(!ShowerEleHolder.CheckElement(fShowerDirectionInputLabel) && !ShowerEleHolder.CheckElement("ShowerStartPosition")){
    ...
    for (auto spacePoint : spacePoints){
      //TVector3 pos = shower::LArPandoraShowerAlg::SpacePointPosition(spacePoint) - showerStartPosition;
      ...
      double proj = shower::LArPandoraShowerAlg::SpacePointProjection(spacePoint, showerStartPosition,
          showerDirection);
      //double proj = shower::LArPandoraShowerAlg::SpacePointProjection(spacePoint, TVector3(0,0,0),
      //    showerDirection);
      if (proj>maxProj) {
        maxProj = proj;
